---
title: "Restaurants Name to Type Mapping"
author: "DS 350"
date: "2026-05-25"
categories: [DS350, buildings]
description: "A mapping of restaurant names to their types."
params: 
    source: "https://github.com/hathawayj/buildings"
    pins_name: 'hathawayj/restaurants'
    available: all
---
...
- __Restaurant:__ The name of the restaurant.
- __Type:__ The type of restaurant (e.g., fast food, casual dining, fine dining, etc.).
...
#| file: ../../../data_scripts/buildings/restaurants.r
```
